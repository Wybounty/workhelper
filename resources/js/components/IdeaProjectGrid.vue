...
async function downloadPdf(project: Project, index: number): Promise<void> {
    ...
    try {
        ...
        const response = await fetch('/ideas/pdf', {
            ...
            body: JSON.stringify({
                project,
                occupation_name: props.occupationName,
                occupation_description: props.occupationDescription,
            }),
        });
        ...
        emit('pdfError', 'Impossible de télécharger le PDF. Réessayez dans un instant.');
    } finally {
